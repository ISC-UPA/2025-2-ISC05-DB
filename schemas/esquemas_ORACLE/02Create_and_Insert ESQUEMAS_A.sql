...
DROP TABLE d_cds;
ALTER TABLE A_DEPARTMENTS DROP CONSTRAINT "DEPT_MGR_FK";
DROP TABLE a_job_grades;
DROP TABLE a_job_history;
DROP TABLE a_employees;
DROP TABLE a_jobs;
DROP TABLE a_departments;
DROP TABLE a_locations;
DROP TABLE a_countries;
DROP TABLE a_regions;
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(964,145,'Republic of Iraq','Iraq','Middle East','Baghdad',437072,58,0,'Persian Gulf',3611,'unnamed peak','28-Jun-2004',NULL,NULL,26783383,2.66,69.01,19.7,111,'mostly desert; mild to cool winters with dry, hot, cloudless summers; northern mountainous a_regions along Iranian and Turkish borders experience cold winters with occasionally heavy snows that melt in early spring, sometimes causing extensive flooding in central and southern Iraq','IZ','.iq','NID');
...
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
VALUES(964,1000,'QY','official in Kurdish a_regions');
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
...
ALTER TABLE  "A_COUNTRIES" ADD CONSTRAINT "COUNTR_REG_FK" FOREIGN KEY ("REGION_ID")
	REFERENCES  "A_REGIONS" ("REGION_ID") ENABLE;
...
ALTER TABLE  "A_LOCATIONS" ADD CONSTRAINT "LOC_C_ID_FK" FOREIGN KEY ("COUNTRY_ID")
	REFERENCES  "A_COUNTRIES" ("COUNTRY_ID") ENABLE;
CREATE INDEX  "LOC_CITY_IX" ON  "A_LOCATIONS" ("CITY");
CREATE INDEX  "LOC_COUNTRY_IX" ON  "A_LOCATIONS" ("COUNTRY_ID");
CREATE INDEX  "LOC_STATE_PROVINCE_IX" ON  "A_LOCATIONS" ("STATE_PROVINCE");
...
ALTER TABLE  "A_DEPARTMENTS" ADD CONSTRAINT "DEPT_LOC_FK" FOREIGN KEY ("LOCATION_ID")
	REFERENCES  "A_LOCATIONS" ("LOCATION_ID") ENABLE;

CREATE INDEX  "DEPT_LOCATION_IX" ON  "A_DEPARTMENTS" ("LOCATION_ID");
...
ALTER TABLE  "A_EMPLOYEES" ADD CONSTRAINT "EMP_DEPT_FK" FOREIGN KEY ("DEPARTMENT_ID")
	REFERENCES  "A_DEPARTMENTS" ("DEPARTMENT_ID") ENABLE;
ALTER TABLE  "A_EMPLOYEES" ADD CONSTRAINT "EMP_JOB_FK" FOREIGN KEY ("JOB_ID")
	REFERENCES  "A_JOBS" ("JOB_ID") ENABLE;
ALTER TABLE  "A_EMPLOYEES" ADD CONSTRAINT "EMP_MANAGER_FK" FOREIGN KEY ("MANAGER_ID")
	REFERENCES  "A_EMPLOYEES" ("EMPLOYEE_ID") ENABLE;
ALTER TABLE  "A_DEPARTMENTS" ADD CONSTRAINT "DEPT_MGR_FK" FOREIGN KEY ("MANAGER_ID")
	REFERENCES  "A_EMPLOYEES" ("EMPLOYEE_ID") DISABLE;
CREATE INDEX  "EMP_DEPARTMENT_IX" ON  "A_EMPLOYEES" ("DEPARTMENT_ID");
CREATE INDEX  "EMP_JOB_IX" ON  "A_EMPLOYEES" ("JOB_ID");
CREATE INDEX  "EMP_MANAGER_IX" ON  "A_EMPLOYEES" ("MANAGER_ID");
CREATE INDEX  "EMP_NAME_IX" ON  "A_EMPLOYEES" ("LAST_NAME", "FIRST_NAME");
...
ALTER TABLE  "A_JOB_HISTORY" ADD CONSTRAINT "JHIST_DEPT_FK" FOREIGN KEY ("DEPARTMENT_ID")
	REFERENCES  "A_DEPARTMENTS" ("DEPARTMENT_ID") ENABLE;
-- the folowing FK constraint is disabled as table contains historical data for a_employees that are not in the current a_employees table
ALTER TABLE  "A_JOB_HISTORY" ADD CONSTRAINT "JHIST_EMP_FK" FOREIGN KEY ("EMPLOYEE_ID")
	  REFERENCES  "A_EMPLOYEES" ("EMPLOYEE_ID") DISABLE;
ALTER TABLE  "A_JOB_HISTORY" ADD CONSTRAINT "JHIST_JOB_FK" FOREIGN KEY ("JOB_ID")
	  REFERENCES  "A_JOBS" ("JOB_ID") ENABLE;
CREATE INDEX  "JHIST_DEPARTMENT_IX" ON  "A_JOB_HISTORY" ("DEPARTMENT_ID");
CREATE INDEX  "JHIST_EMPLOYEE_IX" ON  "A_JOB_HISTORY" ("EMPLOYEE_ID");
CREATE INDEX  "JHIST_JOB_IX" ON  "A_JOB_HISTORY" ("JOB_ID");

--populate a_regions table
INSERT INTO a_regions (region_id, region_name)
Values(1,'Europe');
INSERT INTO a_regions (region_id, region_name)
Values(2,'Americas');
INSERT INTO a_regions (region_id, region_name)
...
--populate a_countries table
INSERT INTO a_countries (country_id, country_name, region_id)
Values('CA','Canada',2);
INSERT INTO a_countries (country_id, country_name, region_id)
Values('DE','Germany',1);
INSERT INTO a_countries (country_id, country_name, region_id)
...
--populate a_locations table
INSERT INTO a_locations (location_id, street_address, postal_code, city, state_province, country_id)
...
--populate a_departments table
INSERT INTO a_departments (department_id, department_name, manager_id, location_id)
...
--populate a_jobs table
INSERT INTO a_jobs (job_id, job_title, min_salary, max_salary)
...
--populate a_employees table
INSERT INTO a_employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)
...
INSERT INTO a_employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id, bonus)
...
--populate a_job_history table
INSERT INTO a_job_history(employee_id,start_date,end_date,job_id,department_id)
...
--populate a_job_grades table
INSERT INTO a_job_grades(grade_level,lowest_sal,highest_sal)
VALUES('A',1000,2999);
INSERT INTO a_job_grades(grade_level,lowest_sal,highest_sal)
VALUES('B',3000,5999);
INSERT INTO a_job_grades(grade_level,lowest_sal,highest_sal)
...
ALTER TABLE  "A_DEPARTMENTS" ENABLE CONSTRAINT "DEPT_MGR_FK";
...
--Create sequence for a_departments PK				
...
--Create sequence for a_employees PK	
...
--Create sequence for a_locations PK	
